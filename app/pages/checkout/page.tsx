      ...
      <div className="flex flex-col md:flex-row">
              ...
              {product.map((item: any, index: number) => (
                <tr key={index} className="border-b">
                  <td className="px-4 py-2">
                    <Image src={item.proImage} alt='tu' width={50} height={50} />
                  </td>
        ...
        <div className="w-full md:w-1/2 md:ml-4">
          <form className="bg-white p-4 rounded-md shadow-md">
            ...
            <button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md">  Proceed to Payment</button>
          </form>
        </div>
      </div>
    </div>

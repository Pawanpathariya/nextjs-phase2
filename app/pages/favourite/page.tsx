  ...
  <>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {favouriteProducts?.length > 0 ? favouriteProducts?.map((item:any,index:number)=>(
          <div key={index} className="max-w-xs bg-white rounded-lg overflow-hidden shadow-lg card card3">
            ...
            <div className="p-4">
              ...
              <div className="flex space-x-4 mt-4">
                ...
                <button className="flex-1 bg-blue-500 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-600 transition-all duration-300" onClick={() => dispatch(removefav(item.id))}>

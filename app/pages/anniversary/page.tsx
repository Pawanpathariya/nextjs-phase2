...
import { Anniversary } from '../../actions/Productcategory';
...
const page:React.FC = () => {
    ...
    const loaddata=async()=>{
        const response= await Anniversary();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-indigo-500 mt-5 mb-4 text-center ">Anniversary Gifts</h1>

              ...
              <tbody>
                {product.map((item: any) => (
                  ...
                  <tr key={item.id} className="hover:bg-gray-100">
                    ...
                    <td>
                    <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md" onClick={()=>ChangeStatus({id:item.id,stat:"Accepted"})}>Accept</button>
                    <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-md" onClick={()=>ChangeStatus({id:item.id,stat:"Rejected"})}>Reject</button>
                    </td>
                  </tr>
                  )
                ))}
